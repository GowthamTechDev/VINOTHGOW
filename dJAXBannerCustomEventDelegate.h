//
//  dJAXBannerCustomEventDelegate.h
//  dJAX_Lib
//
//  Created by dJAX on 13/04/18.
//  Copyright © 2018 dJAX. All rights reserved.
//

#ifndef dJAXBannerCustomEventDelegate_h
#define dJAXBannerCustomEventDelegate_h


#endif /* dJAXBannerCustomEventDelegate_h */
#import <UIKit/UIKit.h>
#import <CoreLocation/CoreLocation.h>

@class dJAXBannerCustomEvent;
/**
...
@protocol dJAXBannerCustomEventDelegate <NSObject>
 ...
 */
- (void)bannerCustomEvent:(dJAXBannerCustomEvent *)event didLoadAd:(UIView *)views;
 ...
 * Failure to do so will disrupt the mediation waterfall and cause future ad requests to stall.
 */
- (void)bannerCustomEvent:(dJAXBannerCustomEvent *)event didFailToLoadAdWithError:(NSError *)error;
 ...
 */
- (void)bannerCustomEventWillBeginAction:(dJAXBannerCustomEvent *)event;
 ...
 * `-bannerCustomEventDidFinishAction:` at a later point.
 */
- (void)bannerCustomEventDidFinishAction:(dJAXBannerCustomEvent *)event;
 ...
 *
 */
- (void)bannerCustomEventWillLeaveApplication:(dJAXBannerCustomEvent *)event;
